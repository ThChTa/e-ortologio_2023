...
public class Activity_December extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.mRecyclerViewDecember);

        setAminoAcidModel();

        AA_RecyclerViewAdapterDecember adapter = new AA_RecyclerViewAdapterDecember(this,aminoAcidModels);
    ...
    private void setAminoAcidModel(){
        ...
        String[] aminoAcidNames = getResources().getStringArray(R.array.names_december_txt);
        String[] aminoAcidPagosmies = getResources().getStringArray(R.array.pagosmies_december_txt);
        String[] aminoAcidDayoffs = getResources().getStringArray(R.array.dayoff_december_txt);
        String n_day = "";
        String emoji = "";
        ...
        for( int i=0; i<31; i++){
            ...
            aminoAcidModels.add(new AminoAcidModel(n_day + (i+1) + " " + aminoAcidMonths[11],aminoAcidNames[i],emojipagosmio + " " + aminoAcidPagosmies[i],emoji + " Αργία : " + aminoAcidDayoffs[i],aminoAcidImages[0]));
