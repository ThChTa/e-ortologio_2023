...
public class Activity_October extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.mRecyclerViewOctober);

        setAminoAcidModel();

        AA_RecyclerViewAdapterOctober adapter = new AA_RecyclerViewAdapterOctober(this,aminoAcidModels);
    ...
    private void setAminoAcidModel(){
        ...
        String[] aminoAcidNames = getResources().getStringArray(R.array.names_october_txt);
        String[] aminoAcidPagosmies = getResources().getStringArray(R.array.pagosmies_october_txt);
        String[] aminoAcidDayoffs = getResources().getStringArray(R.array.dayoff_october_txt);
        String n_day = "";
        String emoji = "";
        for( int i=0; i<31; i++){
            ...
            aminoAcidModels.add(new AminoAcidModel(n_day + (i+1) + " " + aminoAcidMonths[9],aminoAcidNames[i],emojipagosmio + " " + aminoAcidPagosmies[i],emoji + " Αργία : " + aminoAcidDayoffs[i],aminoAcidImages[0]));
