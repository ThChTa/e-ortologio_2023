...
public class Activity_November extends AppCompatActivity {
    ...
    private void setAminoAcidModel(){
        ...
        String[] aminoAcidPagosmies = getResources().getStringArray(R.array.pagosmies_november_txt);
        ...
        for( int i=0; i<30; i++){
            ...
            aminoAcidModels.add(new AminoAcidModel(n_day + (i+1) + " " + aminoAcidMonths[10],aminoAcidNames[i],emojipagosmio + " " + aminoAcidPagosmies[i],emoji + " Αργία : " + aminoAcidDayoffs[i],aminoAcidImages[0]));
